...
## Project Structure
    ...
    ├── googlemaps_dev_25052  # Django project configurations
...
1. Clone this repo and `cd googlemaps_dev_25052`
...
2. Clone this repo and `cd googlemaps_dev_25052`
